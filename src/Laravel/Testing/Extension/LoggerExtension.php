...
use Effulgence\Laravel\Testing\Observability\Logger\InMemory\Memory;
use Effulgence\Laravel\Testing\Observability\Logger\InMemory\Record;
...
trait LoggerExtension
{
    ...
    protected function assertLogged(?string $pattern = null, ?string $level = null): void
    {
        if (! $this->isLoggerSetup) {
            static::fail('Logger is not set up.');
        }
